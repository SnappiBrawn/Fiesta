...
<html>
    ...
    <body>
    <header class="bgimg">
    <?php if($header_flag){require 'utils/dash_header_fac.php';} else{require 'utils/dash_header_stu.php';} ?>
        <div class = "col-md-12">
            <div class = "container">
                <div class = "jumbotron">
    ...
    <div class='row-lg-12 content'>
        ...
        <div class='row-lg-12'>
                <textarea style="border:none; cursor:auto;" readonly><?php echo $prop->getDescription();?></textarea>
        </div>
